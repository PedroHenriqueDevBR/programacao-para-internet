...
class Indexador:
    ...
    def salvar_site(self, a_href, html):
        ...
        # try criado pois estava dadno erro quando tentei pegar o souo.title.string, alguns sites não possuem title
        try:
            title = soup.title.string
        except:
            pass

        # Percorre as tags meta e seleciona a tag meta descricao
        ...
        # Criação da estrutura de retorno
        self.matchs.append(
            {'link': a_href,
             'titulo': title,
             'descricao': descricao
